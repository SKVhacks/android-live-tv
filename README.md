...
### Method 1 — Install APK Manually
1. Copy the APK to your TV or Android Box.
2. Open **File Manager** → select APK.
3. Allow **Unknown Sources**.
4. Install & launch from TV Home screen.
...
This project is licensed under the **MIT License** — feel free to modify, distribute, or use it in your own projects.
